...
exports.StateContainer = exports.StateMetadata = void 0;
...
class StateContainer {
    constructor(state, visibility, owner, allowedUsers) {
        this.state = state;
        this.__metadata = new StateMetadata(visibility, owner, allowedUsers);
    }
    // Checks if a given user has access to this entity
    static isAccessAllowed(stateContainer, user) {
        return StateMetadata.isAccessAllowed(stateContainer.__metadata, user);
    }
}
